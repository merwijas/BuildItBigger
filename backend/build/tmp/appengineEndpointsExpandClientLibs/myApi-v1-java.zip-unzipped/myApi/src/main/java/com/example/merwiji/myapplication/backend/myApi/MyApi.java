 ...
 * on 2017-05-16 at 02:39:28 UTC 
 * Modify at your own risk.
 */

package com.example.merwiji.myapplication.backend.myApi;
...
public class MyApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  /**
   * Create a request for the method "makeAJoke".
   *
   * This request holds the parameters needed by the myApi server.  After setting any optional
   * parameters, call the {@link MakeAJoke#execute()} method to invoke the remote operation.
   *
   * @return the request
   */
  public MakeAJoke makeAJoke() throws java.io.IOException {
    MakeAJoke result = new MakeAJoke();
    initialize(result);
    return result;
  }

  public class MakeAJoke extends MyApiRequest<com.example.merwiji.myapplication.backend.myApi.model.MyBean> {

    private static final String REST_PATH = "makeAJoke";

    /**
     * Create a request for the method "makeAJoke".
     *
     * This request holds the parameters needed by the the myApi server.  After setting any optional
     * parameters, call the {@link MakeAJoke#execute()} method to invoke the remote operation. <p>
     * {@link
     * MakeAJoke#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
     * must be called to initialize this instance immediately after invoking the constructor. </p>
     *
     * @since 1.13
     */
    protected MakeAJoke() {
      super(MyApi.this, "POST", REST_PATH, null, com.example.merwiji.myapplication.backend.myApi.model.MyBean.class);
    }

    @Override
    public MakeAJoke setAlt(java.lang.String alt) {
      return (MakeAJoke) super.setAlt(alt);
    }

    @Override
    public MakeAJoke setFields(java.lang.String fields) {
      return (MakeAJoke) super.setFields(fields);
    }

    @Override
    public MakeAJoke setKey(java.lang.String key) {
      return (MakeAJoke) super.setKey(key);
    }

    @Override
    public MakeAJoke setOauthToken(java.lang.String oauthToken) {
      return (MakeAJoke) super.setOauthToken(oauthToken);
    }

    @Override
    public MakeAJoke setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (MakeAJoke) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public MakeAJoke setQuotaUser(java.lang.String quotaUser) {
      return (MakeAJoke) super.setQuotaUser(quotaUser);
    }

    @Override
    public MakeAJoke setUserIp(java.lang.String userIp) {
      return (MakeAJoke) super.setUserIp(userIp);
    }

    @Override
    public MakeAJoke set(String parameterName, Object value) {
      return (MakeAJoke) super.set(parameterName, value);
    }
  }
  ...
  public class SayHi extends MyApiRequest<com.example.merwiji.myapplication.backend.myApi.model.MyBean> {
